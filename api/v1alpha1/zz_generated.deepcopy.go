...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZkMetadata) DeepCopyInto(out *ZkMetadata) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZkMetadata.
func (in *ZkMetadata) DeepCopy() *ZkMetadata {
	if in == nil {
		return nil
	}
	out := new(ZkMetadata)
